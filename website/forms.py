...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].help_text='<ul class="form-text text-muted small"><li>Your password can\'t be too similar to you other personal information.</li><li>Your password must contain at least 8 characters.</li><li>Your password can\'t be commonly used password.</li><li>Your password can\'t be entirely numeric.</li></ul>'
